...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "My students finally see velocity and acceleration as different things. The phone-as-sensor moment lands every time.",
      name: "Laura Pereda",
      company: "High school physics teacher",
      image: "/testimonial-avatar-1.jpg",
    },
    {
      quote:
        "I used to memorize formulas. Now I tilt my phone and watch them come alive on the board.",
      name: "Mateo Aragón",
      company: "10th grade student",

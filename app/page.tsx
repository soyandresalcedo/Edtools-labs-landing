...
import VoiceCanvasDemo from "../components/voice-canvas-demo"
import PredictMeasureReflectDemo from "../components/predict-measure-reflect-demo"
import PhoneTiltDemo from "../components/phone-tilt-demo"
import ProgressTrailDemo from "../components/progress-trail-demo"
      ...
      <div className="relative flex flex-col justify-start items-center w-full">
        ...
        <div className="w-full max-w-none px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] relative flex flex-col justify-start items-start min-h-screen">
          ...
          <div className="self-stretch pt-[9px] overflow-hidden border-b border-[rgba(55,50,47,0.06)] flex flex-col justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-[66px] relative z-10">
            {/* Navigation */}
            <div className="w-full h-12 sm:h-14 md:h-16 lg:h-[84px] absolute left-0 top-0 flex flex-col justify-center items-center gap-1.5 sm:gap-2 z-20 px-6 sm:px-8 md:px-12 lg:px-0">
              ...
              >
                  <div className="flex justify-center items-center min-w-0 shrink">
                    <a
                      href="#top"
                      className="flex flex-col justify-center text-[#2F3037] text-sm sm:text-base md:text-lg lg:text-xl font-medium leading-5 font-sans no-underline hover:text-[#1a1c24] transition-colors truncate"
                    >
                      Edtools Labs
                    </a>
                  </div>
                  <div className="pl-2 sm:pl-4 md:pl-5 lg:pl-5 flex justify-end items-center flex-wrap flex-row gap-x-2 gap-y-0.5 sm:gap-x-3 md:gap-4 lg:gap-4 min-w-0">
                    <a
                      href="#how-it-feels"
            ...
            <div
              id="top"
              className="scroll-mt-24 pt-16 sm:pt-20 md:pt-24 lg:pt-[216px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full sm:pl-0 sm:pr-0 pl-0 pr-0"
            >
              <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <div className="self-stretch rounded-[3px] flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                  <h1 className="w-full max-w-[748.71px] lg:w-[748.71px] m-0 text-center text-[#37322F] text-[24px] xs:text-[28px] sm:text-[36px] md:text-[52px] lg:text-[80px] font-normal leading-[1.1] sm:leading-[1.15] md:leading-[1.2] lg:leading-24 font-serif px-2 sm:px-4 md:px-0">
                    The AI STEAM tutor.
                    <br />
                    Physics you can feel.
                  </h1>
                  <p className="w-full max-w-[506.08px] lg:w-[506.08px] m-0 text-center text-[rgba(55,50,47,0.80)] sm:text-lg md:text-xl leading-[1.4] sm:leading-[1.45] md:leading-[1.5] lg:leading-7 font-sans px-2 sm:px-4 md:px-0 lg:text-lg font-medium text-sm">
                    Edtools Labs is the open-source AI tutor that turns any
                    <br className="hidden sm:block" />
                    phone into a kinematics lab — voice, ink and tilt sensors in one bilingual flow.
                  </p>
                </div>
              </div>
                ...
                <div className="self-stretch px-4 sm:px-6 md:px-24 py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[586px] px-4 sm:px-6 py-4 sm:py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4 shadow-none">
                    <Badge
                      ...
                      text="Built with"
                    />
                    <h2 className="w-full max-w-[472.55px] m-0 text-center text-[#49423D] text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold leading-tight md:leading-[60px] font-sans tracking-tight">
                ...
                <div className="self-stretch px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[616px] lg:w-[616px] px-4 sm:px-6 py-4 sm:py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4 shadow-none">
                    <Badge
                      ...
                      text="Bento grid"
                    />
                    <h2 className="w-full max-w-[598.06px] lg:w-[598.06px] m-0 text-center text-[#49423D] text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold leading-tight md:leading-[60px] font-sans tracking-tight">
